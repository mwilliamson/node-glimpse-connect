...
module.exports = function() {
    ...
    function use(func) {
        ...
        originalUse.call(this, function(request, response, next) {
            // TODO: wrap response
            // TODO: doesn't work if next is called from somewhere else
            func.call(this, request, response, wrappedNext);
            
            function wrappedNext() {
                dataStore.addMiddleware(request._requestId, func, traceback());
