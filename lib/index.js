...
var glimpsify = module.exports = function glimpsify(app) {
    ...
    app._isGlimpsified = true;
    
    var dataStore = new DataStore();
    
    var originalUse = app.use.original || app.use;
    app.use = use;
...
glimpsify.globalGlimpsify = function() {
    // This is bad. I'm sorry.
    var connectProto = require("connect/lib/proto");
    var originalUse = connectProto.use;
    connectProto.use = function() {
        var app = this;
        glimpsify(app);
        return app.use.apply(this, arguments);
    };
    connectProto.use.original = originalUse;
};
